      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
          ...
          <FadeIn staggerIndex={1} staggerDelay={0.15}>
            <div className="relative p-8 rounded-2xl border-2 border-zap bg-gradient-to-b from-zap-bg to-white ring-2 ring-zap/10 shadow-lg shadow-zap/10 hover:scale-[1.02] transition-all duration-200 h-full">
